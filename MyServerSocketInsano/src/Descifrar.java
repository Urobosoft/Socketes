...
public class Descifrar {
    ...
    cifrado.forEach((clave, valor) -> descifrado.put(valor, clave));
    for (char letra : mensajeCifrado.toCharArray()) {
        char letraDescifrada = descifrado.getOrDefault(letra, letra);
